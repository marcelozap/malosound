...
The homepage uses a full-screen dark signal field, HUD-style top bar, system
...
That means GitHub Pages can publish the site shell and public documents, but the
...
`maloSound.ai` presents MaloSound as the XIV music system:

- XIV is the orchestrator, business, and role-based AI systems layer
- MaloSound is the music and artist-tech system
